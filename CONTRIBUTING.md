...
0. Go to the repo's directory: `cd declarative-shadow-dom`
...
4. Open the demo/preview: [http://localhost:8000/components/declarative-shadow-dom/](http://localhost:8000/components/declarative-shadow-dom/)
5. Open the test suite: [http://localhost:8000/components/declarative-shadow-dom/test/](http://localhost:8000/components/declarative-shadow-dom/test/)
...
All custom elements projects use [`web-component-tester`](https://github.com/Polymer/web-component-tester) for unit tests.
